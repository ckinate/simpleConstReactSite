...
export default function Hero() {
  return (
    <div id='hero' className='bg-black w-full lg:h-[700px] h-fit m-auto pt-[60px] lg:pt-[0px] lg:px-[150px] px-[20px] flex justify-between
     items-center lg:flex-row flex-col lg:gap-5 gap-[50px] bg-cover bg-center' style={{ backgroundImage: `url(${backgroundImage})` }}>
      <motion.div initial="hidden" whileInView='visible' variants={slideUpVariants}
        ...
        <p className='text-white text-[20px]'>Our mission at ProValiant Construction Ltd is to deliver exceptional construction solutions with 
...
approach. We are committed to fostering a culture of integrity, teamwork, and continuous 
          improvement, ensuring that every project we undertake reflects our passion for excellence</p>
        <motion.div initial="hidden" whileInView="visible" variants={zoomInVariants}
          className='flex justify-center items-center gap-5'>
          <motion.button variants={zoomInVariants} className='bg-yellow-500 hover:bg-white hover:text-black px-10 py-3
           rounded-lg text-black font-bold'>
            READ MORE

          </motion.button>
          <motion.button variants={zoomInVariants} className='border-white hover:border-yellow-500 hover:text-yellow-500 border-2
           px-10 py-3 rounded-lg text-black font-bold'>
            REACH US
          </motion.button>
