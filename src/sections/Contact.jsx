...
environment, leaving a lasting positive impact on the communities we serve.
    ...
    <motion.div initial='hidden' whileInView='visible' variants={slideUpVariants}
      className=' lg:w-[40%] w-full flex flex-col justify-center items-start gap-6'>
          <motion.form initial="hidden" whileInView='visible' variants={zoomInVariants}
            ...
            <input type='email' placeholder='Enter Your Email' className='px-6 py-3 border-[2px] border-black text-black rounded-lg w-full' />
            ...
            <textarea placeholder='Enter your message' rows='4' name='' id='' className='px-6 py-3 border-[2px] border-black text-black rounded-lg w-full'></textarea>
            <motion.button variants={zoomInVariants} className='bg-yellow-500 hover:bg-black hover:text-white px-10 py-4
             text-black font-bold rounded-lg w-full'>SUBMIT</motion.button>
