...
export default function Testimonials() {
  return (
    ...
    <motion.div initial='hidden' whileInView='visible' variants={slideUpVariants}
      ...
      <motion.h1 variants={slideUpVariants} className=' text-white uppercase text-[40px] font-bold text-center'> WHAT OUR CLIENTS SAY </motion.h1>
            ...
            clients.map((item, index) => (
              <div key={index} className='flex flex-col justify-center items-center'>
                ...
                <div className='flex flex-col justify-center items-center gap-[5px]'>
                  <img src={item.image} alt='clients image' className='mt-[-50px]' />
